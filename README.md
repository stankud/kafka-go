# kafka-go [![CircleCI](https://circleci.com/gh/segmentio/kafka-go.svg?style=shield)](https://circleci.com/gh/segmentio/kafka-go) [![Go Report Card](https://goreportcard.com/badge/github.com/stankud/kafka-go)](https://goreportcard.com/report/github.com/stankud/kafka-go) [![GoDoc](https://godoc.org/github.com/stankud/kafka-go?status.svg)](https://godoc.org/github.com/stankud/kafka-go)
...
`kafka-go` is currently compatible with golang version from 1.13+. To use with older versions of golang use release [v0.2.5](https://github.com/stankud/kafka-go/releases/tag/v0.2.5).

## Connection [![GoDoc](https://godoc.org/github.com/stankud/kafka-go?status.svg)](https://godoc.org/github.com/stankud/kafka-go#Conn)
...
## Reader [![GoDoc](https://godoc.org/github.com/stankud/kafka-go?status.svg)](https://godoc.org/github.com/stankud/kafka-go#Reader)
...
## Writer [![GoDoc](https://godoc.org/github.com/stankud/kafka-go?status.svg)](https://godoc.org/github.com/stankud/kafka-go#Writer)
...
#### [Plain](https://godoc.org/github.com/stankud/kafka-go/sasl/plain#Mechanism)
```go
...
#### [SCRAM](https://godoc.org/github.com/stankud/kafka-go/sasl/scram#Mechanism)
```go
